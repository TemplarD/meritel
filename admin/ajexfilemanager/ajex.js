	...
	init:function(params){
		...
		if('ckeditor'==this.returnTo){
			if('undefined'!=typeof(params.editor)){
				...
				params.editor.config['filebrowserBrowseUrl']=this.path+'/ftp.html?type=file&connector='+this.connector+'&lang='+this.lang+'&returnTo='+this.returnTo+'&skin='+this.skin+'&contextmenu='+this.contextmenu;
				params.editor.config['filebrowserUploadUrl']=this.path+'/ajax.php?type=file&mode=QuickUpload';
				...
				for(var i in type){
					...
					params.editor.config['filebrowser'+type[i]+'BrowseUrl']=this.path+'/ftp.html?type='+type[i].toLowerCase()+'&connector='+this.connector+'&lang='+this.lang+'&returnTo='+this.returnTo+'&skin='+this.skin+'&contextmenu='+this.contextmenu;
					params.editor.config['filebrowser'+type[i]+'UploadUrl']=this.path+'/ajax.php?mode=QuickUpload&type='+type[i].toLowerCase();
				}
			}else
